 ...
 * mouseClicked method of DisplayJAI so when the mouse is clicked on the image, the
 * clicked point coordinates and pixel values will be stored in a ArrayList which
 * can be accessed later.
 */
public class DisplayJAIWhileStoringCoordinates extends DisplayJAI implements MouseListener
  {
  private ArrayList clicksInformation; // the coordinates where the user clicked
 ...
 /**
  * This method will be called when the mouse is clicked over the image being
  * displayed. The coordinates and pixel value will be stored on an ArrayList.
  ...
  public void mouseClicked(MouseEvent me)
    ...
    if (isDoubleType) // process the pixel as an array of double values
      ...
      if (isIndexed) // if color model is indexed
        ...
        coords.append(" RGB:"+lutData[0][ipixel[0]]+","+
                              lutData[1][ipixel[0]]+","+
                              lutData[2][ipixel[0]]);
        coords.append("]");
        // Put the formatted StringBuffer on the 
 ...
 /**
  * This method allows external classes access to the array of coordinates where
  * the mouse was clicked.
  * @return the array (ArrayList) of click events' information.
  */
  public ArrayList getClicksInformation()
    {
    return clicksInformation;
    }
