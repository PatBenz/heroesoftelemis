...
public class Binarize extends JFrame implements ChangeListener, ActionListener
  ...
  */
  public Binarize(String filename,PlanarImage image)
    {
  ...
  */
  public static void main(String[] args)
    ...
    /*if (args.length != 1)
      {
      System.err.println("Usage: java operators.Binarize image");
      System.exit(0);
      }*/
    // Read the image.
    ...
    if (image.getNumBands() != 1)
      {
      System.err.println("Cannot work with "+image.getNumBands()+"-banded images, sorry");
      System.exit(0);
      }
    // Create the GUI and start the application.
    new Binarize("radio-frontale.jpg",image);
    }
